const Features = () => {
    const features = [
        {
            title: "Processes Slowing You Down?",
            description: "Stop losing time to manual handoffs. We build intelligent workflows that connect your scattered tools and automate complex processes, reducing errors and speeding up delivery.",
            icon: (
        ...
        {
            title: "Team Buried in Busywork?",
            description: "Your talent shouldn't be wasted on data entry. We streamline your operations by automating high-volume, repetitive tasks, freeing your team to focus on high-value strategy and growth.",
            icon: (
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            title: "Generic Tools Limiting You?",
            description: "Your business is unique, and off-the-shelf software often falls short. We develop custom AI agents trained on your specific data to handle specialized tasks and integrate seamlessly with your existing stack.",
            icon: (
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
